...
class FormSuscribe extends FormHelper
{
    ...
    {
        return $this->input_email('email_suscribe', 'email@email.com', '', 'email_suscribe', 'required', false);
    }
    ...
    {
        return $this->input_txt('login', 'Pseudonyme', '', '', 'login', 'required',false);
    }
    ...
    {
        return $this->input_pass('password', 'password', '', 'password_suscribe', 'required', false);
    }
    ...
    {
        return $this->input_submit('submit', '', '', 'submit_suscribe_btn', '', false);
    }
}