...
class FormMobile extends FormHelper
{
    /**
    ...
    {
        return $this->input_email('email', 'Email', 'Email', 'email-mobile', '', false);
    }
    ...
    {
        return $this->input_pass('password', 'password', '', 'password-mobile', '', false);
    }
    ...
    {
        return $this->input_submit('submit_log', '', '', 'submit-mobile', '', false);
    }
}